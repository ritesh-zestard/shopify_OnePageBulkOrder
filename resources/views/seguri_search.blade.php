...
//    $ = jQuery;
    ...
    $(function () {
        ...
        $(".ztpl-addrow").on('click', function () {
            ...
            var quantity_name = $('.ztpl-product_quantity').attr("data-quantity-name");
               
            product_name = (product_name == '')?'Search Product(by name or SKU)':product_name;
            quantity_name = (quantity_name == '')?'Quantity':quantity_name;
            var new_add = '<div class="ztpl-bo-line-item ">' +
                    '<div class="ztpl-row-wrapper">' +
                    '<input name="varient" type="hidden" class="ztpl-varient" />' +
                    '<div class="ztpl-bo-variant-input-section ztpl-col-sm-6 ztpl-col-lg-6 ztpl-col-md-6 ztpl-col-xs-12 ztpl-ui-widget">' +
                    '<input name="search_text" type="text" placeholder="'+product_name+'" maxlength="524288" class="ztpl-bo-variant-input ztpl-search_text" />' +
                    '</div>' +
                    '<div class="ztpl-col-lg-2 ztpl-col-md-2 ztpl-col-sm-2 ztpl-col-xs-4 ztpl-qt_box">' + '<input type="text" class="ztpl-product_quantity" disabled="disabled" placeholder="'+quantity_name+'"/>' +
                    '</div>' +
        ...
        {				
            $(".ztpl-search_text").autocomplete({
                ...
                open: function () {
					...
					if(shop_name == "soc-nation.myshopify.com")
					{
...
<div class="ztpl-bulk-order-wrapper">
    ...
    <div class="ztpl-bo-app">
        ...
        <div class="ztpl-row main-label">
            <div class="ztpl-col-sm-12 ztpl-col-md-6 ztpl-col-lg-6 ztpl-col-xs-12 ztpl-search-label"><?php echo ($shop_find['product_name_label'] != '') ? $shop_find['product_name_label'] : 'Search Product(by name or SKU)' ?></div>
            ...
            for ($i = 0; $i < 5; $i++) {
                ...
                <div class="ztpl-bo-line-item">
                    ...
                    <div class="ztpl-row-wrapper"><input name="varient" type="hidden" class="ztpl-varient" />
                        ...
                        <div class="ztpl-bo-variant-input-section ztpl-col-sm-6 ztpl-col-lg-6 ztpl-col-md-6 ztpl-col-xs-12 ztpl-ui-widget"><input name="search_text" type="text" data-product-name="<?php echo ($shop_find['product_name_label'] != '') ? $shop_find['product_name_label'] : 'Search Product(by name or SKU)' ?>" placeholder="<?php echo ($shop_find['product_name_label'] != '') ? $shop_find['product_name_label'] : 'Search Product(by name or SKU)' ?>
                                                                                                                                                  "maxlength="524288" class="ztpl-bo-variant-input ztpl-search_text" /></div>

                        <div class="ztpl-col-lg-2 ztpl-col-md-2 ztpl-col-sm-2 ztpl-col-xs-4 ztpl-qt_box"><input type="text" class="ztpl-product_quantity" min="1" disabled="disabled" placeholder="<?php echo ($shop_find['quantity_label'] != '') ? $shop_find['quantity_label'] : 'Quantity' ?>" data-quantity-name="<?php echo ($shop_find['quantity_label'] != '') ? $shop_find['quantity_label'] : 'Quantity' ?>" /></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <a class="ztpl-addrow"><span class="ztpl-glyphicon ztpl-glyphicon-plus ztpl-plus-icon"></span><b>Agregar producto</b></a>
            </div>
            <div class="ztpl-bo-line-item ztpl-calculation_box">
                <div class="ztpl-row-wrapper col-md-7">
                    <div class="ztpl-qt_box qtbox_media" style="float: left;margin-left: 10px"><b>Cantidad:</b> <span id="ztpl-total_itams"></span></div>
                </div>
            </div>
        </div>
        <!--Calculation row end-->
        <div class="ztpl-bo-add-line-item ztpl-row-wrapper">
            <div>
                <div class="ztpl-bo-cart-controls row">
                    <div class="ztpl-bo-cart-link ztpl-col-sm-6 ztpl-col-xs-12">
						<button class="ztpl-btn ztpl-btn-primary" onclick="document.location.href = '/cart'">Ver carrito</button>
						<button class="ztpl-btn ztpl-bo-clear-cart ztpl-btn-primary" id="ztpl-empty_cart">Vaciar carrito</button>
					</div>
                    <div class="ztpl-col-sm-6 ztpl-col-xs-12 ztpl-bo-cart-link">
						<button class="ztpl-btn ztpl-bo-update-cart ztpl-btn-primary" id="ztpl-addtocart" disabled="disabled">Agregar al carrito</button>
						<button type="reset" value="Reset" class="ztpl-btn ztpl-btn-primary" id="ztpl-reset_all">Vaciar formulario</button>
					</div>
                </div>
            </div>
        </div>
