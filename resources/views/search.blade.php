        ...
        function run_auto_complete()
        {
            $(".ztpl-search_text").autocomplete({
                        ...
                        success: function (data)
						{
                            response(
								$.map(data.results, function (results){
									//console.log(typeof results.product.tags);
                ...
                select: function (event, ui) {
                    ...
                    $(this).parent().next().find('.ztpl-product_quantity').attr("max", available_stock_qty);
                    ...
                    if (item.inventorystatus == "shopify")
                    {
                        if(item.stock <= 0)
						{
                            ...
                            if (product_image_status == 1)
                            {
								...
								{
									img = "<a href='javascript:void(0)' class='' style=''><img src='" + item.productimage + "' height='32' width='32'/><span>" + item.label + "</span>" + item.label + "&nbsp;&nbsp;&nbsp;&nbsp;(OUT OF STOCK)</a>";
								}
                            }
							else
                            {
								...
								{
									img = "<a href='javascript:void(0)' class='' style=''>" + item.label + "&nbsp;&nbsp;&nbsp;&nbsp;(OUT OF STOCK)</a>";
								}
                            }
							out_of_stock = '<?php echo $shop_find['allow_out_of_stock_products_to_order'] ?>';
							if(parseInt(out_of_stock) == 1)
...
<div class="ztpl-bulk-order-wrapper" id="ztpl-bulk-order-wrapper">
            ...
            for ($i = 0; $i < 5; $i++) {
                ...
                <div class="ztpl-bo-line-item">
                    ...
                    <div class="ztpl-row-wrapper"><input name="varient" type="hidden" class="ztpl-varient" />
                        <div class="ztpl-bo-variant-input-section ztpl-col-sm-5 ztpl-col-lg-5 ztpl-col-md-5 ztpl-col-xs-12 ztpl-ui-widget"><input name="search_text" type="text" data-product-name="<?php echo ($shop_find['product_name_label'] != '') ? $shop_find['product_name_label'] : 'Search Product(by name or SKU)' ?>" placeholder="<?php echo ($shop_find['product_name_label'] != '') ? $shop_find['product_name_label'] : 'Search Product(by name or SKU)' ?>                                                                                                      "maxlength="524288" class="ztpl-bo-variant-input ztpl-search_text" /></div>
...
<div class="quick_order_wrapper" id="quick_order_wrapper" style="display:none">test
</div>
