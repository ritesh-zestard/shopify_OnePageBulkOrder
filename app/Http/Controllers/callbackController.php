...
class callbackController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if (!empty($_GET['shop'])) {
            ...
            if (count($select_store) > 0) {
				...
				if ($shop == "bulk-order.myshopify.com")
				{
                    ...
                    if ($verify) {
                        ...
                        if(count($check_trial) > 0){
                            ...
                            //$current_date = "2019-2-09";
                                ...
                                if ($shop == "all-free-theme-test.myshopify.com" || $shop == "bulk-order.myshopify.com" || $shop == "dipal-test.myshopify.com" ) { 
                            ...
                            if ($shop == "all-free-theme-test.myshopify.com" || $shop == "dipal-test.myshopify.com" || $shop == "bulk-order.myshopify.com") { //vijay-test.myshopify.com  apps-testing-store.myshopify.com zankar-test.myshopify.com  spelean-australia.myshopify.com
                                $url = 'https://' . $shop . '/admin/recurring_application_charges.json';
                                $charge = $sh->call([
                                    'URL' => $url,
                                    'METHOD' => 'POST',
    ...
    public function dashboard(Request $request) {
      ...
      if($shop == "vijay-test.myshopify.com"){
